class Flight:
      ...
      def toString(self):
            return ("\t\tDestino: "+self.destination
            	...
            	+"\n\t\tLugares disponibles clase Turista: "+str(self.touristAvailableSeats)
            	+"\n\t\tLugares disponibles clase Negocios: "+str(self.businessAvailableSeats)
            	+"\n\t\tLugares disponibles clase Primera Clase: "+str(self.firstClassAvailableSeats)
